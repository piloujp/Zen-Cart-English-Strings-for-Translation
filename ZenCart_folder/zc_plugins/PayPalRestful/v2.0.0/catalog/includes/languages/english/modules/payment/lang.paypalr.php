...
// bof constant configuration titles and descriptions for payment module paypalr
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_VERSION' => 'Module Version',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_VERSION' => 'Currently-installed module version.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_STATUS' => 'Enable this Payment Module?',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_STATUS' => 'Do you want to enable this payment module? Use the <b>Retired</b> setting if you are planning to remove this payment module but still have administrative actions to perform against orders placed with this module.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SERVER' => 'Environment',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SERVER' => '<b>Live: </b> Used to process Live transactions<br><b>Sandbox: </b>For developers and testing',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_CLIENTID_L' => 'Client ID (live)',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_CLIENTID_L' => 'The <em>Client ID</em> from your PayPal API Signature settings under *API Access* for your <b>live</b> site. Required if using the <b>live</b> environment.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SECRET_L' => 'Client Secret (live)',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SECRET_L' => 'The <em>Client Secret</em> from your PayPal API Signature settings under *API Access* for your <b>live</b> site. Required if using the <b>live</b> environment.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_CLIENTID_S' => 'Client ID (sandbox)',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_CLIENTID_S' => 'The <em>Client ID</em> from your PayPal API Signature settings under *API Access* for your <b>sandbox</b> site. Required if using the <b>sandbox</b> environment..',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SECRET_S' => 'Client Secret (sandbox)',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SECRET_S' => 'The <em>Client Secret</em> from your PayPal API Signature settings under *API Access* for your <b>sandbox</b> site. Required if using the <b>sandbox</b> environment.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SORT_ORDER' => 'Sort order of display.',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SORT_ORDER' => 'Sort order of display. Lowest is displayed first.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_ZONE' => 'Payment Zone',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_ZONE' => 'If a zone is selected, only enable this payment method for that zone.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_ORDER_STATUS_ID' => 'Completed Order Status',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_ORDER_STATUS_ID' => 'Set the status of orders whose payment has been successfully <em>captured</em> to this status.<br>Recommended: <b>Processing[2]</b><br>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_ORDER_PENDING_STATUS_ID' => 'Set Unpaid Order Status',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_ORDER_PENDING_STATUS_ID' => 'Set the status of orders whose payment has been successfully <em>authorized</em> to this status.<br>Recommended: <b>Pending[1]</b><br>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_REFUNDED_STATUS_ID' => 'Set Refunded Order Status',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_REFUNDED_STATUS_ID' => 'Set the status of <em><b>fully</b>-refunded</em> orders to this status.<br>Recommended: <b>Pending[1]</b><br>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_VOIDED_STATUS_ID' => 'Set Voided Order Status',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_VOIDED_STATUS_ID' => 'Set the status of <em>voided</em> orders to this status.<br>Recommended: <b>Pending[1]</b><br>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_HELD_STATUS_ID' => 'Set Held Order Status',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_HELD_STATUS_ID' => 'Set the status of orders that are held for review to this status.<br>Recommended: <b>Pending[1]</b><br>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_BRANDNAME' => 'Store (Brand) Name at PayPal',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_BRANDNAME' => 'The name of your store as it should appear on the PayPal login page. If blank, your store name will be used.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_TRANSACTION_MODE' => 'Payment Action',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_TRANSACTION_MODE' => 'How do you want to obtain payment?<br><b>Default: Final Sale</b>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_CURRENCY' => 'Transaction Currency',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_CURRENCY' => 'In which currency should the order be sent to PayPal?<br>NOTE: If an unsupported currency is sent to PayPal, it will be auto-converted to the <em>Fall-back Currency</em>.<br><b>Default: Selected Currency</b>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_CURRENCY_FALLBACK' => 'Fall-back Currency',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_CURRENCY_FALLBACK' => 'If the <b>Transaction Currency</b> is set to <em>Selected Currency</em>, what currency should be used as a fall-back when the customer\'s selected currency is not supported by PayPal?<br><b>Default: USD</b>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SCA_ALWAYS' => 'Trigger 3D Secure on <b>Every</b> Txn?',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SCA_ALWAYS' => 'Choose <var>true</var> to trigger 3D Secure for <b>every</b> transaction, regardless of SCA requirements.<br><br><b>Default</b>: <var>false</var>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_ACCEPT_CARDS' => 'Accept Credit Cards?',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_ACCEPT_CARDS' => 'Should the payment-module accept credit-card payments? If running <var>live</var> transactions, your storefront <b>must</b> be configured to use <var>https</var> protocol for the card-payments to be accepted!<br><br>If your store uses One-Page Checkout, you can limit credit-card payments to account-holders.<br><b>Default: false</b>',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_HANDLING_OT' => 'List <var>handling-fee</var> Order-Totals',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_HANDLING_OT' => 'Identify, using a comma-separated list (intervening spaces are OK), any order-total modules &mdash; <em>other than</em> <code>ot_loworderfee</code> &mdash; that add a <em>handling-fee</em> element to an order.  Leave the setting as an empty string if there are none (the default).',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_INSURANCE_OT' => 'List <var>insurance</var> Order-Totals',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_INSURANCE_OT' => 'Identify, using a comma-separated list (intervening spaces are OK), any order-total modules that add an <em>insurance</em> element to an order.  Leave the setting as an empty string if there are none (the default).',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_DISCOUNT_OT' => 'List <var>discount</var> Order-Totals',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_DISCOUNT_OT' => 'Identify, using a comma-separated list (intervening spaces are OK), any order-total modules &mdash; <em>other than</em> <code>ot_coupon</code>, <code>ot_gv</code> and <code>ot_group_pricing</code> &mdash; that add a <em>discount</em> element to an order.  Leave the setting as an empty string if there are none (the default).',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_DEBUGGING' => 'Debug Mode',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_DEBUGGING' => 'Would you like to enable debug mode?  A complete detailed log of failed transactions will be emailed to the store owner.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SOFT_DESCRIPTOR' => 'Store (Sub-Brand) Identifier at PayPal',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SOFT_DESCRIPTOR' => 'On customer credit card statements, your company name will show as <code>PAYPAL*(yourname)*(your-sub-brand-name)</code> (max 22 letters for (yourname)*(your-sub-brand-name)). You can add the sub-brand-name here if you want to differentiate purchases from this store vs any other PayPal sales you make.',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_PAYLATER_MESSAGING' => 'PayLater Messaging',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_PAYLATER_MESSAGING' => 'On which pages should PayPal PayLater messaging be displayed? (It will automatically not be displayed in regions where it is not available. Only available in USD, GBP, EUR, AUD.) When enabled, it will show the lower installment-based pricing for the presented product or cart amount. This may accelerate buying decisions.<br>To disable, leave all unticked.',

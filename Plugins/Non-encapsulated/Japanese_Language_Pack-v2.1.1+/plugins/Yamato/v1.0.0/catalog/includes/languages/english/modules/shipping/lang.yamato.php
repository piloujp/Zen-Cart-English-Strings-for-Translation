...
//bof constant configuration titles and descriptions for Yamato Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_YAMATO_CATEGORIES' => 'Enable or Disable Yamato shipping method for some categories',
    'CFGDESC_MODULE_SHIPPING_YAMATO_CATEGORIES' => 'Do you want to enable or disable Yamato shipping for some categories?',
    'CFGTITLE_MODULE_SHIPPING_YAMATO_CAT_LIST' => 'Enable/Disable categories IDs list',
    'CFGDESC_MODULE_SHIPPING_YAMATO_CAT_LIST' => 'Comma separated list of categoies IDs to be enabled or disabled, depending on above option.',
    'CFGTITLE_MODULE_SHIPPING_YAMATO_PRODUCTS' => 'Enable or Disable Yamato shipping method for some products',
    'CFGDESC_MODULE_SHIPPING_YAMATO_PRODUCTS' => 'Do you want to enable or disable Yamato shipping for some products?',
    'CFGTITLE_MODULE_SHIPPING_YAMATO_PROD_LIST' => 'Enable/Disable products IDs list',
    'CFGDESC_MODULE_SHIPPING_YAMATO_PROD_LIST' => 'Comma separated list of products IDs to be enables or disabled, depending on above option.',

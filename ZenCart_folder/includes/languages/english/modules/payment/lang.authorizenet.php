...
$define = [
    ...
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_OWNER' => '* The owner\'s name of the credit card must be at least ' . zen_config('CC_OWNER_MIN_LENGTH') . ' characters.\n',
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_NUMBER' => '* The credit card number must be at least ' . zen_config('CC_NUMBER_MIN_LENGTH') . ' characters.\n',

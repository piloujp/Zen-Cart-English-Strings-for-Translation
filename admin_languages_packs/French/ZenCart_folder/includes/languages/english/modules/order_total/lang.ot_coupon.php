...
$define['MODULE_ORDER_TOTAL_COUPON_REMOVE_INSTRUCTIONS'] = '<p>Pour Enlever un coupon de réduction de cette commande, remplacez le code de coupon par : ' . $define['TEXT_COMMAND_TO_DELETE_CURRENT_COUPON_FROM_ORDER'] . '<p>Pour Enlever un coupon de réduction de cette commande, remplacez le code de coupon par : \' . $define[\'TEXT_COMMAND_TO_DELETE_CURRENT_COUPON_FROM_ORDER\'] . \'</p>';

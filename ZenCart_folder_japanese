...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALWPP_TEXT_ADMIN_TITLE_PRO20' => 'PayPalエクスプレスチェックアウト (Pro 2.0 Payflowエディション) (UK)',
    'MODULE_PAYMENT_PAYPALWPP_TEXT_ADMIN_TITLE_PF_EC' => 'PayPal Payflow Pro - ゲートウェイ',
    'MODULE_PAYMENT_PAYPALWPP_TEXT_ADMIN_TITLE_PF_GATEWAY' => 'Paypalエクスプレスチェックアウトvia Payflow Pro',
    ...
    'MODULE_PAYMENT_PAYPALWPP_DP_TEXT_TYPE' => 'PayPalダイレクト支払い',
    ...
    'MODULE_PAYMENT_PAYPALWPP_FUNDING_ERROR' => 'お支払い資金に問題; Paypal.com サイトから直接' . STORE_OWNER_EMAIL_ADDRESS,

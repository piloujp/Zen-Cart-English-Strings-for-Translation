...
$define = [
    ...
    'MODULE_ORDER_TOTAL_GV_HEADER' => TEXT_GV_NAMES . '/割引クーポン',
...
// Beginning of constant configuration titles and descriptions for order total module ot_gv
    ...
    'CFGTITLE_MODULE_ORDER_TOTAL_GV_SHOW_QUEUE_IN_ADMIN' => '管理ヘッダーにキューを表示しますか？',
    'CFGDESC_MODULE_ORDER_TOTAL_GV_SHOW_QUEUE_IN_ADMIN' => '管理のすべてのページにキュー ボタンを表示しますか?<br>（キューに何もない場合は自動的に非表示になり、この設定に関係なく、[注文] 画面に自動的に表示されます）',

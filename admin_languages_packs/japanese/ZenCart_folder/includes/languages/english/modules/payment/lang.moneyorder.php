...
$define = [
    ...
    'MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION' => '顧客は支払いを郵送することができます。 注文確認メールでは、次のことを求められます。 <br><br>小切手またはマネーオーダーの支払い先は次のとおりです：<br>' . (defined('MODULE_PAYMENT_MONEYORDER_PAYTO') ? MODULE_PAYMENT_MONEYORDER_PAYTO : '<br>(あなたの店名)') . '<br><br>お支払いは次の宛先に郵送してください：<br>' . nl2br(STORE_NAME_ADDRESS) . '<br><br>' . 'ご注文は、支払いを受け取るまで発送されません。',
// Beginning of constant configuration titles and descriptions for payment module moneyorder

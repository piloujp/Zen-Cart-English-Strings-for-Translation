...
// Admin configuration
    ...
    'CFGTITLE_ACCESSBLOCK_BLOCKED_COMPANIES' => 'Block by: Create-account Company',
    'CFGDESC_ACCESSBLOCK_BLOCKED_COMPANIES' => 'Enter, using a comma-separated list, any <em>Company</em> entries to be blocked from creating an account.  If the company value entered on the <code>create_account</code> page <em>contains</em> any of the strings entered here, the account-creation will be blocked.',

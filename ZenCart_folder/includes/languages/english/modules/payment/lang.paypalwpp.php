...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALWPP_FUNDING_ERROR' => 'Funding source problem; please go to Paypal.com and make payment directly to ' . zen_config('STORE_OWNER_EMAIL_ADDRESS'),
    ...
    'MODULE_PAYMENT_PAYPALWPP_TEXT_JS_CC_OWNER' => '* The cardholder\'s name must be at least ' . zen_config('CC_OWNER_MIN_LENGTH') . ' characters.\n',
    'MODULE_PAYMENT_PAYPALWPP_TEXT_JS_CC_NUMBER' => '* The credit card number must be at least ' . zen_config('CC_NUMBER_MIN_LENGTH') . ' characters.\n',
...
if (IS_ADMIN_FLAG === true) {
    ...
    $define['MODULE_PAYMENT_PAYPALWPP_TEXT_ADMIN_DESCRIPTION'] = '<strong>PayPal Express Checkout</strong>%s<br>' . (substr($define['MODULE_PAYMENT_PAYPALWPP_MODULE_MODE'], 0, 7) == 'Payflow' ? '<a href="https://manager.paypal.com/loginPage.do?partner=ZenCart" rel="noreferrer noopener" target="_blank">Manage your PayPal account.</a>' : '<a href="https://www.paypal.com" rel="noopener" target="_blank">Manage your PayPal account.</a>') . '<br><br><font color="green">Configuration Instructions:</font><br><span class="alert">1. </span><a href="https://www.zen-cart.com/partners/paypal-ec" rel="noopener" target="_blank">Sign up for your PayPal account - click here.</a><br>' .
        (zen_config('MODULE_PAYMENT_PAYPALWPP_STATUS') !== null ? '' : '... and click "install" above to enable PayPal Express Checkout support.<br><a href="https://www.zen-cart.com/getpaypal" rel="noopener" target="_blank">For additional detailed help, see this FAQ article</a><br>') .
